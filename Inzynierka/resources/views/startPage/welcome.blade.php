...
<head>
    ...
    <!--====== Favicon Icon ======-->
    <link rel="shortcut icon" href="{{asset('public/MainPageTemplate/assets/images/favicon.png')}}" type="image/png">

    <!--====== Magnific Popup CSS ======-->
    <link rel="stylesheet" href="{{asset('public/MainPageTemplate/assets/css/magnific-popup.css')}}">

    <!--====== Slick CSS ======-->
    <link rel="stylesheet" href="{{asset('public/MainPageTemplate/assets/css/slick.css')}}">

    <!--====== Line Icons CSS ======-->
    <link rel="stylesheet" href="{{asset('public/MainPageTemplate/assets/css/LineIcons.css')}}">

    <!--====== Bootstrap CSS ======-->
    <link rel="stylesheet" href="{{asset('public/MainPageTemplate/assets/css/bootstrap.min.css')}}">

    <!--====== Default CSS ======-->
    <link rel="stylesheet" href="{{asset('public/MainPageTemplate/assets/css/default.css')}}">

    <!--====== Style CSS ======-->
    <link rel="stylesheet" href="{{asset('public/MainPageTemplate/assets/css/style.css')}}">
            ...
            <div class="col-lg-12">
                <nav class="navbar navbar-expand-lg">
                    ...
                    <a class="navbar-brand" href="#">
                        <img src="{{asset('public/MainPageTemplate/assets/images/logo.svg')}}" alt="Logo">
                    </a>
            ...
            <div class="carousel-item active">
                ...
                <div class="slider-image-box d-none d-lg-flex align-items-end">
                    <div class="slider-image">
                        <img src="{{asset('public/MainPageTemplate/assets/images/slider/1.png')}}" alt="Hero">
                    </div> <!-- slider-imgae -->
                ...
                <div class="single-features mt-40">
                    <div class="features-title-icon d-flex justify-content-between">
                        ...
                        <div class="features-icon">
                            ...
                            <img class="shape" src="{{asset('public/MainPageTemplate/assets/images/f-shape-1.svg')}}" alt="Shape">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-sm-6 branding-4 planning-4">
                        <div class="single-portfolio">
                            <div class="portfolio-image">
                                <img src="{{asset('public/MainPageTemplate/assets/images/portfolio/1.png')}}" alt="">
                                <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                    <div class="portfolio-content">
                                        <div class="portfolio-icon">
                                            <a class="image-popup" href="{{asset('public/MainPageTemplate/assets/images/portfolio/1.png')}}"><i class="lni lni-zoom-in"></i></a>
                                            <img src="{{asset('public/MainPageTemplate/assets/images/portfolio/shape.svg')}}" alt="shape" class="shape">
                                        </div>
                                        <div class="portfolio-icon">
            ...
            <div class="col-lg-4 col-md-7 col-sm-9">
                <div class="pricing-style mt-30">
                    ...
                    <div class="pricing-btn rounded-buttons text-center">
                        <a class="main-btn rounded-one" href="#">ZALOGUJ</a>
                    </div>
...
<!--====== Jquery js ======-->
<script src="{{asset('public/MainPageTemplate/assets/js/vendor/jquery-1.12.4.min.js')}}"></script>
<script src="{{asset('public/MainPageTemplate/assets/js/vendor/modernizr-3.7.1.min.js')}}"></script>

<!--====== Bootstrap js ======-->
<script src="{{asset('public/MainPageTemplate/assets/js/popper.min.js')}}"></script>
<script src="{{asset('public/MainPageTemplate/assets/js/bootstrap.min.js')}}"></script>

<!--====== Slick js ======-->
<script src="{{asset('public/MainPageTemplate/assets/js/slick.min.js')}}"></script>

<!--====== Magnific Popup js ======-->
<script src="{{asset('public/MainPageTemplate/assets/js/jquery.magnific-popup.min.js')}}"></script>

<!--====== Ajax Contact js ======-->
<script src="{{asset('public/MainPageTemplate/assets/js/ajax-contact.js')}}"></script>

<!--====== Isotope js ======-->
<script src="{{asset('public/MainPageTemplate/assets/js/imagesloaded.pkgd.min.js')}}"></script>
<script src="{{asset('public/MainPageTemplate/assets/js/isotope.pkgd.min.js')}}"></script>

<!--====== Scrolling Nav js ======-->
<script src="{{asset('public/MainPageTemplate/assets/js/jquery.easing.min.js')}}"></script>
<script src="{{asset('public/MainPageTemplate/assets/js/scrolling-nav.js')}}"></script>

<!--====== Main js ======-->
<script src="{{asset('public/MainPageTemplate/assets/js/main.js')}}"></script>
